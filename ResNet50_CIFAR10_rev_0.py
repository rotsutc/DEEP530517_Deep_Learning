...
base_model = ResNet50(weights=None,      # huấn luyện từ đầu (do CIFAR-10 khác ImageNet)
                      include_top=False, # bỏ fully-connected gốc
                      input_shape=(32,32,3))

model = models.Sequential([
    base_model,
    layers.GlobalAveragePooling2D(),  # thay Flatten bằng GAP
